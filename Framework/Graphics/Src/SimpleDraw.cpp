...
namespace
{
    ...
    public:
        ...
        void AddFace(const Math::Vector3& v0, const Math::Vector3 v1, Math::Vector3 v2, const Color& color);
    ...
    void SimpleDrawImpl::AddFace(const Math::Vector3& v0, const Math::Vector3 v1, Math::Vector3 v2, const Color& color)
    {
